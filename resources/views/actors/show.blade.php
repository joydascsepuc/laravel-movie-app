...
@section('content')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                    @foreach ($knownForMovies as $movie)
                        <div class="mt-4">
                            ...
                            <a href="{{ $movie['linkToPage'] }}" class="text-sm leading-normal block text-white-400 hover:text-white mt-1">{{ $movie['title'] }}</a>
                        </div>
    ...
    <div class="credits border-b border-white-800">
